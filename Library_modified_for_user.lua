...
local Library = {
    ...
    Scheme = {
        ...
        AccentColor = Color3.fromRGB(180, 210, 255), -- 轻淡蓝
...
do
    ...
    Library:UpdateDPI(FPSLabel, { Position = false, Size = false })
    ...
    Library:GiveSignal(RunService.RenderStepped:Connect(function(dt)
        ...
        if tick() - lastTime >= 0.5 then
            local fps = math.floor(frames / (tick() - lastTime) + 0.5)
    ...
    local vert = makePart(2, 16)
    local horz = makePart(16, 2)
    Library.Registry[vert] = { BackgroundColor3 = "AccentColor" }
    Library.Registry[horz] = { BackgroundColor3 = "AccentColor" }
