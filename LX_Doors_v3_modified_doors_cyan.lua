...
local Tabs = {
    General = Window:AddTab("常规"),
    Exploit = Window:AddTab("外挂"),
    ESP = Window:AddTab("ESP"),
    Visuals = Window:AddTab("视觉"),
    Misc = Window:AddTab("杂项"),
    Config = Window:AddTab("配置")
}

-- 常规（Automation）
local GeneralAutomation = Tabs.General:AddLeftGroupbox("自动化")
GeneralAutomation:AddToggle("GA_AutoInteract", { Text = "自动交互", Default = false, }):AddKeyPicker("GA_AutoInteract_K", { Default = "R", SyncToggleState = false, Mode = "Hold", Text = "自动交互 按键", NoUI = false, Tooltip = "按键按下时自动激活附近可交互物。" })
GeneralAutomation:AddDropdown("GA_AutoInteract_Options", { Values = { "使用撬锁（门）", "使用撬锁（其他）", "忽略光源", "忽略可致死糖果" }, Default = 0, Multi = true, Text = "自动交互 选项" })
GeneralAutomation:AddSlider("GA_AutoInteract_Range", { Text = "范围倍率", Default = 1, Min = 1, Max = 2, Rounding = 1, Compact = false })
GeneralAutomation:AddDivider()
GeneralAutomation:AddToggle("GA_EatCandies", { Text = "自动使用糖果", Default = false, }):AddKeyPicker("GA_EatCandies_K", { Default = "V", SyncToggleState = false, Mode = "Hold", Text = "自动使用糖果 按键", NoUI = false, Tooltip = "按键按下时自动使用背包中的糖果。" })
GeneralAutomation:AddToggle("GA_AutoHide", { Text = "自动躲藏", Default = false, Tooltip = "启用时会预测实体并自动躲进最近的隐藏位置。" })
GeneralAutomation:AddToggle("GA_AutoHide_VisCheck", { Text = "预测可见性检查", Default = false })
...
GeneralAutomation:AddSlider("GA_AutoHide_PredictionDistanceMultiplier", { Text = "距离倍率", Default = 1, Min = 0.8, Max = 1.5, Rounding = 1, Compact = true, Suffix = "x" })
GeneralAutomation:AddDivider()
GeneralAutomation:AddToggle("GA_MinecartInteract", { Text = "矿车交互刷取", Default = false, Tooltip = "按键按下时会自动刷取矿车交互。" }):AddKeyPicker("GA_MinecartInteract_K", { Default = "H", SyncToggleState = false, Mode = "Hold", Text = "矿车交互 按键", NoUI = false })
GeneralAutomation:AddToggle("GA_AnchorAutoSolve", { Text = "自动解决锚点", Default = false, Tooltip = "靠近指定锚点时自动尝试提交答案。" })
GeneralAutomation:AddDivider()
GeneralAutomation:AddToggle("GA_AutoPadlockSolve", { Text = "自动解开图书馆挂锁", Default = false, Tooltip = "靠近图书馆挂锁时自动输入正确代码。" })
GeneralAutomation:AddSlider("GA_AutoPadlockSolve_Distance", { Text = "自动挂锁距离", Default = 25, Min = 10, Max = 50, Rounding = 0, Compact = false, Tooltip = "触发自动输入挂锁代码的最小距离。"})

-- 通知（Notifying）
local GeneralNotifying = Tabs.General:AddRightGroupbox("通知")
GeneralNotifying:AddToggle("GN_Enabled", { Text = "启用通知", Default = false, Tooltip = "通知总开关。" })
GeneralNotifying:AddToggle("GN_NotificationSound", { Text = "播放声音", Default = false, Tooltip = "通知时播放声音。" })
GeneralNotifying:AddSlider("GN_NotificationSound_Volume", { Text = "声音音量", Default = 2, Min = 1, Max = 10, Rounding = 1, Compact = false })
GeneralNotifying:AddDivider()
GeneralNotifying:AddToggle("GN_AnchorCode", { Text = "锚点代码通知", Default = false, Tooltip = "检测到锚点代码时发出通知。" })
GeneralNotifying:AddToggle("GN_PadlockCode", { Text = "挂锁代码通知", Default = false, Tooltip = "检测到挂锁代码时发出通知。" })
GeneralNotifying:AddToggle("GN_Entities", { Text = "实体生成通知", Default = false, Tooltip = "选中实体生成时发出通知。" })
GeneralNotifying:AddDropdown("GN_Entities_Options", { Values = { "Rush", "Blitz", "Ambush", "Eyes", "Lookman", "Halt", "Screech", "Gloombat Swarm", "Dread", "A-60", "A-120" }, Default = 0, Multi = true, Text = "实体白名单", Tooltip = "要通知的实体列表（实体名保持原样，不翻译）" })
GeneralNotifying:AddDivider()
GeneralNotifying:AddDropdown("GN_NotificationAlignment", { Values = { "左", "中", "右" }, Default = 2, Multi = false, Text = "水平对齐" })
GeneralNotifying:AddSlider("GN_NotificationOffset_X", { Text = "X 偏移", Default = 0, Min = -1, Max = 1, Rounding = 2, Compact = true })
GeneralNotifying:AddSlider("GN_NotificationOffset_Y", { Text = "Y 偏移", Default = 0, Min = -1, Max = 1, Rounding = 2, Compact = true })
GeneralNotifying:AddSlider("GN_NotificationDPISize", { Text = "大小倍率", Default = 1, Min = 0.8, Max = 3, Rounding = 1, Compact = true })
GeneralNotifying:AddButton("测试通知", function()
    Notify("测试通知", "这是一条测试通知。", 2.5, true)
end)

-- 外挂（Exploits）
local ExploitSelf = Tabs.Exploit:AddLeftGroupbox("自身")
ExploitSelf:AddToggle("ES_AlwaysJump", { Text = "始终允许跳跃", Default = false, Tooltip = "始终允许跳跃。" })
ExploitSelf:AddDivider()
ExploitSelf:AddToggle("ES_AntiGloombat", { Text = "反 Gloombat 蛋", Default = false, Tooltip = "阻止触碰 Gloombat 蛋的碰撞盒。" })
ExploitSelf:AddToggle("ES_AntiGiggle", { Text = "反 Giggle", Default = false, Tooltip = "阻止触碰 Giggle 的碰撞盒。" })
ExploitSelf:AddToggle("ES_AntiSnare", { Text = "反 Snare", Default = false, Tooltip = "阻止触碰实体 Snare。" })
ExploitSelf:AddToggle("ES_AntiDupe", { Text = "反 Dupe", Default = false, Tooltip = "阻止触碰伪门的碰撞盒。" })
ExploitSelf:AddToggle("ES_AntiEyes", { Text = "反 Eyes", Default = false, Tooltip = "在 Eyes 实体时强制低头。" })
ExploitSelf:AddToggle("ES_AntiLookman", { Text = "反 Lookman", Default = false, Tooltip = "在 Lookman 实体时强制低头。" })
ExploitSelf:AddToggle("ES_AntiChanedlier", { Text = "反 吊灯", Default = false, Tooltip = "阻止在 seek 追逐时触碰掉落的吊灯。" })
ExploitSelf:AddToggle("ES_AntiSeekArms", { Text = "反 Seek 手臂", Default = false, Tooltip = "阻止触碰 seek 手臂。" })

local ExploitTroll = Tabs.Exploit:AddLeftGroupbox("捣蛋")
ExploitTroll:AddToggle("Spamtoolz", { Text = "刷别人道具（Spam）", Default = false, Tooltip = "通过触发其他玩家的道具远程事件来刷耗材。" }):AddKeyPicker("Spamtoolz_X", { Default = "G", SyncToggleState = false, Mode = "Hold", Text = "刷道具 按键" })
ExploitTroll:AddInput("WhitelistKoolpeople",{Default = "", Numeric = false, Finished = true, ClearTextOnFocus = true, Text = "刷子白名单（玩家名）", Callback = function() end})

local ExploitBypass = Tabs.Exploit:AddRightGroupbox("反检测")
ExploitBypass:AddToggle("EB_CrouchSpoof", { Text = "蹲下伪装", Default = false, Tooltip = "向服务器伪装为蹲下状态，适用于某些房间。" })
ExploitBypass:AddToggle("EB_SpeedBypass", { Text = "速度绕过", Default = false, Tooltip = "尝试缓解速度反作弊。" })
ExploitBypass:AddToggle("EB_ACManipulate", { Text = "反作弊位移操纵", Default = false, Tooltip = "将角色瞬移到相反方向以尝试操纵反作弊。"}):AddKeyPicker("EB_ACManipulate_K", { Default = "T", SyncToggleState = false, Mode = "Hold", Text = "位移操纵 按键" })

local ExploitRemovals = Tabs.Exploit:AddRightGroupbox("移除")
ExploitRemovals:AddToggle("ER_RemoveSeek", { Text = "移除 Seek 追逐", Default = false, Tooltip = "完全禁用实体 Seek。" })
ExploitRemovals:AddToggle("ER_NoScreech", { Text = "禁用 Screech", Default = false, Tooltip = "完全禁用实体 Screech。" })
ExploitRemovals:AddToggle("ER_NoA90", { Text = "禁用 A-90", Default = false, Tooltip = "完全禁用实体 A-90。" })
ExploitRemovals:AddToggle("ER_NoShade", { Text = "禁用 Halt", Default = false, Tooltip = "完全禁用实体 Halt。" })
ExploitRemovals:AddDivider()
ExploitRemovals:AddToggle("ER_NoA90Damage", { Text = "免受 A-90 伤害", Default = false, Tooltip = "阻止 A-90 对你造成伤害。" })
ExploitRemovals:AddToggle("ER_NoScreechDamage", { Text = "免受 Screech 伤害", Default = false })
ExploitRemovals:AddToggle("ER_NoShadeDamage", { Text = "免受 Halt 伤害", Default = false })

-- ESP (左侧玩家 / 右侧交互物)
local ESPLXUSER = Tabs.ESP:AddLeftGroupbox("LX 用户")
ESPLXUSER:AddToggle("LXPP_Enabled", { Text = "LX 用户 ESP", Default = false })
:AddColorPicker("LXPLAYERFILLCOLOR", { Default = Color3.new(0.141176, 0.792156, 0.282352), Title = "填充颜色" })
:AddColorPicker("LXPPLAYEROUTLINECOLOR", { Default = Color3.new(0.141176, 0.792156, 0.282352), Title = "轮廓颜色" })
ESPLXUSER:AddDivider()

local ESPPlayers = Tabs.ESP:AddLeftGroupbox("玩家")
ESPPlayers:AddToggle("ESPP_Enabled", { Text = "启用玩家 ESP", Default = false })
:AddColorPicker("ESPPLAYERFILLCOLOR", { Default = Color3.new(1, 1, 1), Title = "填充颜色" })
:AddColorPicker("ESPPLAYEROUTLINECOLOR", { Default = Color3.new(1, 1, 1), Title = "轮廓颜色" })

local ESPInteractables = Tabs.ESP:AddRightTabbox("可交互物")

local ESPInteractables_Main = ESPInteractables:AddTab("主设置")
ESPInteractables_Main:AddToggle("ESPI_M_Enabled", { Text = "启用可交互物 ESP", Default = false })
ESPInteractables_Main:AddDivider()
ESPInteractables_Main:AddToggle("ESPI_M_Name", { Text = "显示名称", Default = false })
ESPInteractables_Main:AddToggle("ESPI_M_Distance", { Text = "显示距离", Default = false })
ESPInteractables_Main:AddToggle("ESPI_M_Fill", { Text = "高亮填充", Default = false })
ESPInteractables_Main:AddToggle("ESPI_M_Enabled", { Text = "高亮轮廓", Default = false })

local ESPInteractables_Configurate = ESPInteractables:AddTab("配置")
ESPInteractables_Configurate:AddToggle("ESPI_C_Doors", { Text = "门 (亲测颜色)", Default = false })
:AddColorPicker("ESPI_C_Doors_F", { Default = Color3.new(0, 1, 1), Title = "门 - 亲测颜色" })
:AddColorPicker("ESPI_C_Doors_O", { Default = Color3.new(0, 0.8, 0.8), Title = "门 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_DoorKeys", { Text = "钥匙", Default = false })
:AddColorPicker("ESPI_C_DoorKeys_F", { Default = Color3.new(1, 0.8431372549019608, 0), Title = "钥匙 填充颜色" })
:AddColorPicker("ESPI_C_DoorKeys_O", { Default = Color3.new(0.8, 0.6, 0), Title = "钥匙 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_GoldPiles", { Text = "金币堆", Default = false })
:AddColorPicker("ESPI_C_GoldPiles_F", { Default = Color3.new(1, 0.85, 0.2), Title = "金币 填充颜色" })
:AddColorPicker("ESPI_C_GoldPiles_O", { Default = Color3.new(0.8, 0.65, 0.1), Title = "金币 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_GeneratorFuses", { Text = "发电机保险丝", Default = false })
:AddColorPicker("ESPI_C_GeneratorFuses_F", { Default = Color3.new(0.6, 0.6, 0.6), Title = "保险丝 填充颜色" })
:AddColorPicker("ESPI_C_GeneratorFuses_O", { Default = Color3.new(0.4, 0.4, 0.4), Title = "保险丝 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_Generators", { Text = "发电机", Default = false })
:AddColorPicker("ESPI_C_Generators_F", { Default = Color3.new(0.2, 0.9, 0.2), Title = "发电机 填充颜色" })
:AddColorPicker("ESPI_C_Generators_O", { Default = Color3.new(0.1, 0.6, 0.1), Title = "发电机 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_GateLevers", { Text = "门闸拉杆", Default = false })
:AddColorPicker("ESPI_C_GateLevers_F", { Default = Color3.new(0.4, 0.8, 1), Title = "闸杆 填充颜色" })
:AddColorPicker("ESPI_C_GateLevers_O", { Default = Color3.new(0.2, 0.5, 0.7), Title = "闸杆 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_LibraryBooks", { Text = "图书馆书籍", Default = false })
:AddColorPicker("ESPI_C_LibraryBooks_F", { Default = Color3.new(0.9, 0.6, 0.2), Title = "书籍 填充颜色" })
:AddColorPicker("ESPI_C_LibraryBooks_O", { Default = Color3.new(0.6, 0.4, 0.1), Title = "书籍 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_BreakerPoles", { Text = "断路杆", Default = false })
:AddColorPicker("ESPI_C_BreakerPoles_F", { Default = Color3.new(0.7, 0.7, 0.7), Title = "断路杆 填充颜色" })
:AddColorPicker("ESPI_C_BreakerPoles_O", { Default = Color3.new(0.5, 0.5, 0.5), Title = "断路杆 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_Anchors", { Text = "锚点", Default = false })
:AddColorPicker("ESPI_C_Anchors_F", { Default = Color3.new(0.5, 0.25, 1), Title = "锚点 填充颜色" })
:AddColorPicker("ESPI_C_Anchors_O", { Default = Color3.new(0.4, 0.2, 0.8), Title = "锚点 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_BackroomsLevers", { Text = "计时杆", Default = false })
:AddColorPicker("ESPI_C_BackroomsLevers_F", { Default = Color3.new(1, 0.5, 0.2), Title = "计时杆 填充颜色" })
:AddColorPicker("ESPI_C_BackroomsLevers_O", { Default = Color3.new(0.8, 0.3, 0.1), Title = "计时杆 轮廓颜色" })

ESPInteractables_Configurate:AddToggle("ESPI_C_MiscPickups", { Text = "杂项拾取物", Default = false })
:AddColorPicker("ESPI_C_MiscPickups_F", { Default = Color3.new(0.9, 0.9, 0.9), Title = "杂项 填充颜色" })
:AddColorPicker("ESPI_C_MiscPickups_O", { Default = Color3.new(0.7, 0.7, 0.7), Title = "杂项 轮廓颜色" })

-- ESP 设置
local ESPSettings = Tabs.ESP:AddRightGroupbox("ESP 设置")
ESPSettings:AddDropdown("ESPS_Font", { Values = { "Arial", "SourceSans", "Highway", "Fantasy", "Gotham", "DenkOne", "JosefinSans", "Nunito", "Oswald", "RobotoMono", "Sarpanch", "Ubuntu" }, Default = 9, Multi = false, Text = "字体" })
...
ESPSettings:AddDivider()
ESPSettings:AddSlider("ESPS_FadeTime", { Text = "淡入/淡出 时间", Default = 1, Min = 0, Max = 2, Rounding = 2, Compact = true, Suffix = "s" })

-- 视觉
local VisualsView = Tabs.Visuals:AddLeftGroupbox("视角")
VisualsView:AddSlider("VV_FieldOfView", { Text = "视野（FOV）", Default = 0, Min = 0, Max = 120, Rounding = 0, Compact = true, Tooltip = "改变相机视野。" })
VisualsView:AddToggle("VV_NoCamShake", { Text = "移除相机抖动", Default = false, Tooltip = "移除实体或其他来源引起的相机抖动。" })
VisualsView:AddToggle("VV_NoLookBob", { Text = "移除视角晃动", Default = false, Tooltip = "移除行走时的视角晃动。" })
VisualsView:AddDivider()
VisualsView:AddToggle("VV_Thirdperson", { Text = "第三人称", Default = false, Tooltip = "以第三人称查看角色。" }):AddKeyPicker("VV_Thirdperson_K", { Default = "V", SyncToggleState = false, Mode = "Toggle", Text = "第三人称 按键" })
VisualsView:AddToggle("VV_ThirdpersonCamCollision", { Text = "摄像机墙体检测", Default = false, Tooltip = "启用墙体检测以避免穿墙。" })
VisualsView:AddSlider("VV_ThirdpersonDistance", { Text = "距离", Default = 10, Min = 5, Max = 30, Rounding = 0, Compact = true, Tooltip = "第三人称相机距离。" })
VisualsView:AddSlider("VV_ThirdpersonOffset", { Text = "水平偏移", Default = 0, Min = -5, Max = 5, Rounding = 1, Compact = true, Tooltip = "第三人称左右偏移。" })
VisualsView:AddSlider("VV_ThirdpersonOffsetUp", { Text = "垂直偏移", Default = 0, Min = -5, Max = 5, Rounding = 1, Compact = true, Tooltip = "第三人称上下偏移。" })
VisualsView:AddDivider()
VisualsView:AddToggle("VV_ViewmodelOffset", { Text = "视角模型偏移", Default = false, Tooltip = "修改手持工具的视角偏移。" })
...
VisualsWorld:AddToggle("VW_Ambience", { Text = "环境颜色", Default = false, Tooltip = "改变地图环境颜色。" }):AddColorPicker("VW_Ambience_C", { Default = Color3.new(1, 1, 1), Title = "环境 颜色" })
VisualsWorld:AddToggle("VW_NoFog", { Text = "移除雾效", Default = false, Tooltip = "如果存在则移除地图雾效。" })
VisualsWorld:AddDivider()
VisualsWorld:AddToggle("VW_RushNodes", {Text = "显示 Rush 路径", Tooltip = "显示 Rush 和 Ambush 的路径。"})

local VisualsRemovals = Tabs.Visuals:AddRightGroupbox("视觉移除")
VisualsRemovals:AddToggle("VR_NoHasteEffect", { Text = "移除 Haste 效果", Default = false, Tooltip = "移除 haste 出现时的红色滤镜与晕影。" })
VisualsRemovals:AddToggle("VR_NoHidingVignette", { Text = "移除隐藏晕影", Default = false, Tooltip = "隐藏时移除晕影。" })
VisualsRemovals:AddToggle("VR_NoHaltEffect", { Text = "移除 Halt 特效", Default = false, Tooltip = "移除 halt 房间的闪烁效果。" })
VisualsRemovals:AddToggle("VR_NoReviveCutscene", { Text = "移除复活过场", Default = false, Tooltip = "移除复活时的心形过场。" })
VisualsRemovals:AddDivider()
VisualsRemovals:AddToggle("VR_TimothyJumpscare", { Text = "移除 Timothy 恐吓动画", Default = false, Tooltip = "移除 Timothy 的 jumpscare。" })
VisualsRemovals:AddToggle("VR_NoGlitchJumpscare", { Text = "移除 Glitch 恐吓", Default = false })
VisualsRemovals:AddToggle("VR_NoVoidEffect", { Text = "移除 Void 效果", Default = false })
VisualsRemovals:AddToggle("VR_NoSeekEffects", { Text = "移除 Seek 房间效果", Default = false })

-- 杂项（Movement / Audio / Other）
local MiscMovement = Tabs.Misc:AddLeftGroupbox("移动")
MiscMovement:AddToggle("MM_Walkspeed", { Text = "启用速度修改", Default = false, Tooltip = "根据设置的数值设置玩家移动速度。" })
MiscMovement:AddSlider("MM_Walkspeed_S", { Text = "移动速度数值", Default = 20, Min = 10, Max = 50, Rounding = 0, Compact = true, Tooltip = "控制玩家移动速度。" })
MiscMovement:AddSlider("MM_Walkspeed_Boost", { Text = "梯子速度加成", Default = 0, Min = 0, Max = 50, Rounding = 0, Compact = true, Tooltip = "爬梯子时的速度加成，过高可能不稳定。" })
MiscMovement:AddDivider()
MiscMovement:AddToggle("MM_NoAcceleration", { Text = "移除加速度", Default = false, Tooltip = "移动或改变方向时移除加速度效果。" })

local MiscAudio = Tabs.Misc:AddRightGroupbox("音频")
MiscAudio:AddToggle("MA_SilentJammin", { Text = "静音商店音乐", Default = false, Tooltip = "移除 jeffs 商店的背景音乐。" })
MiscAudio:AddDivider()
MiscAudio:AddToggle("MA_NoHasteSound", { Text = "移除 Haste 音效", Default = false, Tooltip = "静音 haste 出现时的环境音效。" })
MiscAudio:AddToggle("MA_SilentInteracting", { Text = "移除交互音效", Default = false, Tooltip = "交互提示时不播放音效。" })
MiscAudio:AddToggle("MA_NoRandomAmbience", { Text = "移除随机环境音", Default = false, Tooltip = "移除可能出现的随机噪声环境音。" })
MiscAudio:AddToggle("MA_SilentGloombat", { Text = "静音 Gloombat", Default = false, Tooltip = "静音飞行或咆哮的 gloombat。" })

local MiscellaneousOther = Tabs.Misc:AddLeftGroupbox("其他")
MiscellaneousOther:AddToggle("MO_antirobloxvoid", { Text = "禁用 Roblox 传送销毁", Default = false, Tooltip = "移除 ROBLOX 死亡高度销毁。" })
MiscellaneousOther:AddDivider()
MiscellaneousOther:AddButton("重新开始", function()
    game.ReplicatedStorage.RemotesFolder.PlayAgain:FireServer()
end)
MiscellaneousOther:AddButton("回到大厅", function()
...
MenuProperties:AddLabel("菜单绑定"):AddKeyPicker("MenuKeybind", { Default = "RightShift", NoUI = true, Text = "菜单键" })
MenuProperties:AddDivider()
MenuProperties:AddToggle("keybindmenu", { Text = "显示按键绑定列表", Default = false })
...
ThemeManager:SetFolder("mspaint/Themes")
...
DebugStuff:AddToggle("DS_Debug", { Text = "启用调试模式", Default = false })
