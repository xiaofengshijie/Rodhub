...
if game:GetService("ReplicatedStorage"):FindFirstChild("RemotesFolder") or game.ReplicatedStorage:FindFirstChild("EntityInfo") or game.ReplicatedStorage:FindFirstChild("Bricks") then
    ...
    -- Main render loop and connection handling
...
-- Rest of the code for other games remains the same as it's not part of the main DOORS functionality
-- ... (other game place IDs and their respective code)
[file content end]