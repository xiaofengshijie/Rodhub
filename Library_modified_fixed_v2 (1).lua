...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(255, 255, 255), -- 透明效果由控件透明度控制
        MainColor = Color3.fromRGB(255, 255, 255),
        AccentColor = Color3.fromRGB(173, 216, 230), -- 浅蓝色 (light blue)
        OutlineColor = Color3.fromRGB(153, 204, 255), -- 浅蓝描边
...
do
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        local KeybindsToggle = { Normal = KeyPicker.Mode ~= "开关" }; do
        ...
        function KeyPicker:DoClick()
            ...
            if ParentObj.Type == "开关" and KeyPicker.SyncToggleState then
...
do
    ...
    function Funcs:AddButton(...)
        ...
        function Button:UpdateColors()
            ...
            Button.Base.BackgroundColor3 = Button.Disabled and Library.Scheme.BackgroundColor
                or Library.Scheme.MainColor
            Button.Base.TextTransparency = Button.Disabled and 0.8 or 0.15
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        function Dropdown:Display()
            ...
            Display.Text = (Str == "" and "未选择" or Str)
        end
...
function Library:CreateWindow(WindowInfo)
    ...
    if Library.IsMobile then
        ...
        local LockButton = Library:AddDraggableButton("锁定", function(self)
            ...
            self:SetText(Library.CantDragForced and "未锁定" or "锁定")
        end)
