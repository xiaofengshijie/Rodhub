...
do
    ...
    DotLabel.Size = UDim2.fromScale(1, 0.4)
    DotLabel.Position = UDim2.fromScale(0, 0.6)
    DotLabel.BackgroundTransparency = 1
    DotLabel.TextScaled = true
    DotLabel.Text = ""
    DotLabel.FontFace = Library.Scheme.Font
    DotLabel.TextColor3 = Library.Scheme.FontColor
    ...
    -- 主 UI 在此之前保持隐藏（已在创建时设置 Enabled = false）
end
