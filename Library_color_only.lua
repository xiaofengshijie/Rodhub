...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(255, 255, 255), 15, 15),
        MainColor = Color3.fromRGB(255, 255, 255), 25, 25),
        AccentColor = Color3.fromRGB(173, 216, 230) -- 浅蓝色, 85, 255),
        OutlineColor = Color3.fromRGB(153, 204, 255) -- 浅蓝描边, 40, 40),
        FontColor = Color3.fromRGB(20, 20, 20) -- 深色，保证文字可读, 1, 1),
